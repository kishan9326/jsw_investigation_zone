...
@section('content-header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Reconnect World Quetions</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Reconnect World Quetions</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Reconnect World Quetions</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('updateReconnectQuetions') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Quetion</label>
                                <textarea class="ckeditor" name="quetions">
                                    {{ $data[0]->quetions }}
                                </textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mcq_options" placeholder="MCQ options" value="{{ $data[0]->mcq_options }}">
                            </div>

                            <div class="form-group">
                                    <label for="exampleInputPassword1">MCQ correct answer</label>
                                    <input type="text" class="form-control" name="mcq_correct_answer" placeholder="MCQ options" value="{{ $data[0]->mcq_correct_answer }}">
                            </div>
