                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Reconnect World Quetions</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('saveReconnectQuetions') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mcq_options" placeholder="MCQ options">
                            </div>

                            <div class="form-group">
                                    <label for="exampleInputPassword1">MCQ correct answer</label>
                                    <input type="text" class="form-control" name="mcq_correct_answer" placeholder="MCQ options">
                            </div>
