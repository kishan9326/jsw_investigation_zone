            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('update_rescue_champs_hindi') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="eight_screen_button_text"
                                        placeholder="Eight Screen Button Text" value="{{ $data_img[0]->eight_screen_button_text }}">
                                </div>
                                ...
                                <img src="{{ asset('uploads/' . $data_img[0]->eleven_screen_image) }}"
                                alt="Tagline" width="100" class="tagline-img-preview" style="cursor: pointer">
                                <div class="form-group">
                                ...
                                <img src="{{ asset('uploads/' . $data_img[0]->twelve_screen_image) }}"
                                alt="Tagline" width="100" class="tagline-img-preview" style="cursor: pointer">
                                <div class="form-group">
                                ...
                                <img src="{{ asset('uploads/' . $data_img[0]->therteen_screen_image) }}"
                                alt="Tagline" width="100" class="tagline-img-preview" style="cursor: pointer">
                                <div class="form-group">
                                ...
                                <img src="{{ asset('uploads/' . $data_img[0]->fourteen_screen_image) }}"
                                alt="Tagline" width="100" class="tagline-img-preview" style="cursor: pointer">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">try_again_button_text</label>
                                        <input type="text" class="form-control" name="try_again_button_text"
                                            placeholder="Main tag line first" value="{{ $data_img[0]->try_again_button_text }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">next_button_text</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">enter_button_text</label>
